...
const schema = Joi.object({
  ...
  ASSISTANT_API_URL: Joi.string().allow("").default(""),
...
export const config = Object.freeze({
  ...
  assistantApiUrl: (env["ASSISTANT_API_URL"] || env["LOOM_API_URL"] || env["DIFY_API_URL"] || "").replace(/\/+$/, ""),
  assistantApiKey: env["ASSISTANT_API_KEY"] || env["LOOM_API_KEY"] || env["DIFY_API_KEY"] || "",
  loomApiUrl: (env["ASSISTANT_API_URL"] || env["LOOM_API_URL"] || env["DIFY_API_URL"] || "").replace(/\/+$/, ""),
  loomApiKey: env["ASSISTANT_API_KEY"] || env["LOOM_API_KEY"] || env["DIFY_API_KEY"] || "",
